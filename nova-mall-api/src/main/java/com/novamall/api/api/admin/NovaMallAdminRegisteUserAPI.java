...
public class NovaMallAdminRegisteUserAPI {

    private static final Logger logger = LoggerFactory.getLogger(NovaMallAdminRegisteUserAPI.class);
    ...
    public Result list(@RequestParam(required = false) @ApiParam(value = "页码") Integer pageNumber,
        ...
        return ResultGenerator.genSuccessResult(novaMallUserService.getNovaMallUsersPage(pageUtil));
    }
    ...
    public Result lockUser(@RequestBody BatchIdParam batchIdParam, @PathVariable int lockStatus, @TokenToAdminUser AdminUserToken adminUser) {
        ...
        if (novaMallUserService.lockUsers(batchIdParam.getIds(), lockStatus)) {
